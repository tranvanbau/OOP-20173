...
public class Images {
    ...
    public static final Image BRICK = new ImageIcon(
            Images.class.getResource("/image/map/brick.png")).getImage();
    public static final Image HOME = new ImageIcon(
            Images.class.getResource("/image/map/bird.png")).getImage();

    public static final Image MY_TANK_LEFT = new ImageIcon(
            Images.class.getResource("/image/player/player_green_left.png"))
            .getImage();

    public static final Image MY_TANK_RIGHT = new ImageIcon(
            Images.class.getResource("/image/player/player_green_right.png"))
            .getImage();
    public static final Image MY_TANK_UP = new ImageIcon(
            Images.class.getResource("/image/player/player_green_up.png"))
            .getImage();
    public static final Image MY_TANK_DOWN = new ImageIcon(
            Images.class.getResource("/image/player/player_green_down.png"))
            .getImage();


    public static final Image ENEMY_TANK_LEFT = new ImageIcon(
            Images.class.getResource("/image/boss/bossyellow_left.png")).getImage();


    public static final Image ENEMY_TANK_RIGHT = new ImageIcon(
            Images.class.getResource("/image/boss/bossyellow_right.png"))
            .getImage();


    public static final Image ENEMY_TANK_UP = new ImageIcon(
            Images.class.getResource("/image/boss/bossyellow_up.png")).getImage();


    public static final Image ENEMY_TANK_DOWN = new ImageIcon(
            Images.class.getResource("/image/boss/bossyellow_down.png")).getImage();
